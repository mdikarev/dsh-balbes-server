...
5. Список selectable пресетов — отображаемые данные (provider id + отображаемое название; названия — бренды, англ.) в
...
- Модалка «+ Добавить»: селект «Провайдер»: пресеты (отображаемые названия из MODEL_PROVIDER_PRESETS) +
