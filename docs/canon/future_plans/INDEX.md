...
| 9 | Апрувы из Telegram: канал запрашивает, владелец даёт | implementing | p9-telegram-approvals.md |
...
approval у владельца, владелец даёт одноразовое решение) — инициатива p9 в статусе
`implementing` (дизайн утверждён, реализация начата).
