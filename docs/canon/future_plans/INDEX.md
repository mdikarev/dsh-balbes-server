...
| 6 | Сессии воркспейса из Telegram: новые и возврат к старым | draft | p5-telegram-sessions.md |
...
воркспейса из Telegram (создание новых и возврат к старым) — черновик p5;
