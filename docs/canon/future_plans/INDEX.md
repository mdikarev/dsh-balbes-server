...
| 13 | Список дел пользователя: межпроектный todo | draft | p13-user-todo-list.md |
...
Межпроектный список дел владельца (единый серверный список, команды управления,
визуализация в админке, чтение из любого воркспейса; структурированный частный
случай памяти) — черновик p13; пересечение с памятью уточняется в p10.
