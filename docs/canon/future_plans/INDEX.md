...
реализована и абсорбирована, а создание сессии из админки и чат владельцем не
планируются. Поверх базового слоя строятся просмотр сессий (p2), просмотр
файлов (p3), каналы, память и самообучение — они оформляются отдельными
инициативами. Наполнение дома по глобальному контексту (правила
