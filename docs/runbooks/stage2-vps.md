...
зоны (таб **«Сессии»** остаётся первым и незакрываемым): текст моноширинно
в своей прокрутке, большой файл — с пометкой «Файл показан не полностью»,
пустой — «Файл пуст», бинарный и симлинк — понятное «нельзя показать».
Кнопка **«Обновить»** перечитывает активный таб.
